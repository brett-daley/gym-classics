...
| `WindyGridworld-v0` | Windy Gridworld.<br><br>Page 130 of Sutton & Barto (2018). |
| `WindyGridworldKings-v0` | Windy Gridworld with King's moves.<br><br>Page 131 of Sutton & Barto (2018). |
| `WindyGridworldKingsNoOp-v0` | Windy Gridworld with King's moves and a no-op action.<br><br>Page 131 of Sutton & Barto (2018). |
| `WindyGridworldKingsStochastic-v0` | Windy Gridworld with King's moves and stochastic wind.<br><br>Page 131 of Sutton & Barto (2018). |
